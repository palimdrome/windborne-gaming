...
function Contact (props) {
    return (
        <section className='min-h-fit max-w-full flex flex-col lg:justify-center lg:items-center gap-y-5 lg:gap-y-10 px-10 p-32 left-7 bg-right bg-no-repeat bg-cover' style={{backgroundImage: `url(${background})`}}>
