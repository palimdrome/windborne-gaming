            ...
            <div className="hero min-h-screen bg-left" style={{backgroundImage: `url(${background})`}}>
                ...
                <div className="hero-content text-center text-white lg:max-w-full md:max-w-3xl max-w-xl flex flex-wrap lg:flex-col md:flex-col justify-start lg:justify-center md:justify-center gap-y-5 px-10 lg:pt-20 md:pt-20">
                    ...
                    <div className='relative lg:h-16 h-14 w-full'>
                        <h1 className="title lg:text-8xl text-7xl text-left lg:text-center md:text-center font-bold absolute top-0.5 lg:-top-2 left-0 right-0 ml-auto mr-auto">Traveler</h1>
                    ...
                    <p className="max-w-lg text-lg text-left lg:text-center md:text-center p-1">Join us as we journey through immersive worlds and conquer challenges together. Embark on your gaming odyssey today.</p>
