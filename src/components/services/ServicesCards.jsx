...
function ServicesCards({service}) {
    ...
    return (
        <div>
            ...
            <a    className="card w-64 h-64 text-white shadow-md hover:shadow-xl hover:shadow-stone-900/50 transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-110 duration-300" 
                    style={{
