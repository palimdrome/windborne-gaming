...
function Footer (props) {
    ...
    return (
        <footer className="bg-primary min-h-fit flex flex-col lg:flex-row justify-center items-center lg:justify-between gap-y-3 lg:gap-y-10 p-8 lg:p-4 lg:px-20">
